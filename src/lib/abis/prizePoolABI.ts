export const prizePoolABI = [
  ...
  { inputs: [{ internalType: 'uint48', name: 'drawClosesAt', type: 'uint48' }], name: 'AwardingDrawNotClosed', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint104', name: 'requestedLiquidity', type: 'uint104' }], name: 'InsufficientLiquidity', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint8', name: 'numTiers', type: 'uint8' }], name: 'NumberOfTiersGreaterThanMaximum', type: 'error' },
  { inputs: [{ internalType: 'uint8', name: 'numTiers', type: 'uint8' }], name: 'NumberOfTiersLessThanMinimum', type: 'error' },
  ...
  { inputs: [{ internalType: 'SD59x18', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Ceil_Overflow', type: 'error' },
  { inputs: [{ internalType: 'int256', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Convert_Overflow', type: 'error' },
  { inputs: [{ internalType: 'int256', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Convert_Underflow', type: 'error' },
  ...
  { inputs: [{ internalType: 'SD59x18', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Exp2_InputTooBig', type: 'error' },
  { inputs: [{ internalType: 'SD59x18', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Log_InputTooSmall', type: 'error' },
  ...
  { inputs: [{ internalType: 'SD59x18', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Sqrt_NegativeInput', type: 'error' },
  { inputs: [{ internalType: 'SD59x18', name: 'x', type: 'int256' }], name: 'PRBMath_SD59x18_Sqrt_Overflow', type: 'error' },
  { inputs: [{ internalType: 'uint256', name: 'x', type: 'uint256' }], name: 'PRBMath_UD60x18_Convert_Overflow', type: 'error' },
