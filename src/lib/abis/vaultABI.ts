export const vaultABI = [
  ...
  { inputs: [{ internalType: 'address', name: 'asset', type: 'address' }], name: 'FailedToGetAssetDecimals', type: 'error' },
  ...
  { inputs: [{ internalType: 'address', name: 'tokenOut', type: 'address' }], name: 'LiquidationTokenOutNotSupported', type: 'error' },
  {
    inputs: [
