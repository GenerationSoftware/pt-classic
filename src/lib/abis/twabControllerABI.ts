export const twabControllerABI = [
  ...
  { inputs: [{ internalType: 'uint32', name: 'periodOffset', type: 'uint32' }], name: 'PeriodOffsetInFuture', type: 'error' },
  { inputs: [{ internalType: 'address', name: 'delegate', type: 'address' }], name: 'SameDelegateAlreadySet', type: 'error' },
  {
    inputs: [
