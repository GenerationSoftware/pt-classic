export const twabRewardsABI = [
  ...
  { inputs: [{ internalType: 'uint64', name: 'epochEndTimestamp', type: 'uint64' }], name: 'EpochNotOver', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint256', name: 'gracePeriodEndTimestamp', type: 'uint256' }], name: 'GracePeriodActive', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint256', name: 'promotionId', type: 'uint256' }], name: 'InvalidPromotion', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint256', name: 'promotionId', type: 'uint256' }], name: 'PromotionInactive', type: 'error' },
  {
    inputs: [
