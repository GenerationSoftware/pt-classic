export const swapperABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint32', name: 'defaultScaledOfferFactor', type: 'uint32' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'tokenToBeneficiary', type: 'address' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint32[]', name: 'pairScaledOfferFactors', type: 'uint32[]' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint32', name: 'defaultScaledOfferFactor', type: 'uint32' },
          {
            components: [
              {
                components: [
  ...
  { inputs: [], name: 'payback', outputs: [], stateMutability: 'payable', type: 'function' },
  {
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'defaultScaledOfferFactor_', type: 'uint32' }],
    name: 'setDefaultScaledOfferFactor',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  ...
  {
    inputs: [{ internalType: 'address', name: 'tokenToBeneficiary_', type: 'address' }],
    name: 'setTokenToBeneficiary',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
