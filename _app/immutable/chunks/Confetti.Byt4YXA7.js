import{s as M,n as m,c as v,g as k}from"./scheduler.BtZbm0j3.js";import{S as w,i as x,z as f,g as d,d as h,C as T,H as C,D as N}from"./index.-yqi0WvP.js";import{j as _}from"./vectorMath.D1-glhvy.js";import{w as S}from"./index.C0C0tZ2p.js";function A(a,o){const n={},t={},e={$$scope:1};let r=a.length;for(;r--;){const i=a[r],l=o[r];if(l){for(const s in i)s in l||(t[s]=1);for(const s in l)e[s]||(n[s]=l[s],e[s]=1);a[r]=l}else for(const s in i)e[s]=1}for(const i in t)i in n||(n[i]=void 0);return n}function q(a){return typeof a=="object"&&a!==null?a:{}}function g(a,o,n){const t=a.slice();return t[1]=o[n],t}function b(a){let o,n;return{c(){o=new C(!1),n=f(),this.h()},l(t){o=N(t,!1),n=f(),this.h()},h(){o.a=n},m(t,e){o.m(p,t,e),d(t,n,e)},p:m,d(t){t&&(h(n),o.d())}}}function y(a){let o=a[1],n,t=b();return{c(){t.c(),n=f()},l(e){t.l(e),n=f()},m(e,r){t.m(e,r),d(e,n,r)},p(e,r){r&1&&M(o,o=e[1])?(t.d(1),t=b(),t.c(),t.m(n.parentNode,n)):t.p(e,r)},d(e){e&&h(n),t.d(e)}}}function F(a){let o,n=_([...a[0]]),t=[];for(let e=0;e<n.length;e+=1)t[e]=y(g(a,n,e));return{c(){for(let e=0;e<t.length;e+=1)t[e].c();o=f()},l(e){for(let r=0;r<t.length;r+=1)t[r].l(e);o=f()},m(e,r){for(let i=0;i<t.length;i+=1)t[i]&&t[i].m(e,r);d(e,o,r)},p(e,[r]){if(r&1){n=_([...e[0]]);let i;for(i=0;i<n.length;i+=1){const l=g(e,n,i);t[i]?t[i].p(l,r):(t[i]=y(l),t[i].c(),t[i].m(o.parentNode,o))}for(;i<t.length;i+=1)t[i].d(1);t.length=n.length}},i:m,o:m,d(e){e&&h(o),T(t,e)}}}const c=800,$=[16758326,3535056,16402664,6109847];let p=`<svg
    class="confetti"
    viewBox="0 0 ${c} ${c}"
  ...
  </g>`}p+="</svg>";const u=S(new Set),B=()=>{for(const o of[...k(u)])clearTimeout(o),u.update(n=>(n.delete(o),n));const a=setTimeout(()=>{u.update(o=>(o.delete(a),o))},5e3);u.update(o=>o.add(a))};function L(a,o,n){let t;return v(a,u,e=>n(0,t=e)),[t]}class D extends w{constructor(o){super(),x(this,o,L,F,M,{})}}export{D as C,q as a,A as g,B as p};
